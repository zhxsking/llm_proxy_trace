...
export async function handleProxy(
  ...
  try {
    ...
    if (isStream && upstreamResp.body) {
      return proxySSEStream(upstreamResp, trace, collector, ws, startTime);
    }
    ...
    // Extract usage
    const usage = extractUsageFromResponse(respBody as Record<string, unknown>);
...
function extractUsageFromResponse(body: Record<string, unknown>): import('../types.js').TokenUsage | undefined {
